    ...
    <div class="container">
        ...
        <form action="{{ url('employee/store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ $employee->name }}" class="form-control" id="">
            </div>
            <div class="form-group">
                <label for="">Email</label>
                <input type="email" name="email" value="{{ $employee->email }}" class="form-control" id="">
            </div>
            <div class="form-group">
                <label for="">Birth Date</label>
                <input type="date" name="dob" value="{{ $employee->birth_date }}" class="form-control" id="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="salary" value="{{ $employee->salary }}" class="form-control" id="">
            </div>
            <div class="form-group">
